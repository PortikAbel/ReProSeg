...
def compute_rf_prototype(img_size, prototype_patch_index, protoL_rf_info):
    ...
    rf_indices = compute_rf_protoL_at_spatial_location(img_height, img_width, height_index, width_index, protoL_rf_info)
    return [
        img_index,
        rf_indices[0],
        rf_indices[1],
...
def compute_rf_prototypes(img_size, prototype_patch_indices, protoL_rf_info):
    ...
    for prototype_patch_index in prototype_patch_indices:
        ...
        rf_indices = compute_rf_protoL_at_spatial_location(
            img_height, img_width, height_index, width_index, protoL_rf_info
        )
